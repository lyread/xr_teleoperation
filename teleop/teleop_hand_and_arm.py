...
if __name__ == '__main__':
    ...
    try:
        ...
        # television: obtain hand pose data from the XR device and transmit the robot's head camera image to the XR device.get_data
        ...
        if args.ee == "dex3":
            ...
            gripper_ctrl = Dex1_1_Gripper_Controller(left_gripper_value, right_gripper_value, dual_gripper_data_lock, dual_gripper_state_array,
                                                      dual_gripper_action_array, simulation_mode=args.sim)
        ...
        while not STOP:
            ...
            # get current robot state data.获得对应机械臂信息
